  ...
  <div className="fixed inset-0 z-50 bg-black bg-opacity-80 flex items-center justify-center px-4">
    <div className="relative w-full max-w-4xl aspect-video bg-black rounded-lg overflow-hidden">
      <button
        ...
        className="absolute top-4 right-7 text-white text-4xl font-bold hover:text-black transition z-10"
      >
        &times;
      </button>
      {/* Destroy video when modal closes */}
      {showVideo && (
        <video key="packgine-video" className="w-full h-full" controls autoPlay>
      ...
      <section className="bg-[#faf9f9] py-16 md:py-24 px-4 sm:px-8 lg:px-20 max-w-[1600px] mx-auto">
  <h2 className="text-3xl sm:text-4xl font-bold text-primary mb-10 sm:mb-16 text-center">
    Value Proposition
  </h2>

  <p className="text-gray-700 text-base sm:text-lg leading-relaxed max-w-full mb-16 text-justify">
    Packgine is an innovative platform designed to help brands navigate the complexities of sustainable packaging.
    It provides essential tools and resources to assess the environmental impact of packaging materials, ensuring
    brands can make informed decisions.
  </p>
