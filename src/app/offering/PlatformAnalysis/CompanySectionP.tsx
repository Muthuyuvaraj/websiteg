    ...
    <section className='bg-[#faf9f9]'>
        <section>
         ...
         <section className="flex flex-col md:flex-row w-full h-screen -mt-44" >
            ...
            <div className="w-full md:w-1/2 text-white p-10 md:p-20 flex flex-col justify-center ml-12">
                ...
                gCurv leverages our vast packaging database to help our customers compare themselves against industry leaders and competitors
                </p>
            </div>
        ...
        <section className="flex flex-col md:flex-row w-full h-screen -mt-44" >
            ...
            <div className="w-full md:w-1/2 text-white p-10 md:p-20 flex flex-col justify-center ml-12">
                ...
                <p className="text-gray-400 text-lg leading-relaxed mb-10">
                    gCurv can provide our customers with supplier specific, robust environmental Impact analyses of their individual components products
                </p> 
                <p className="text-gray-400 text-lg leading-relaxed mb-10">
        ...
        <section className="flex flex-col md:flex-row w-full h-screen -mt-44" >
            ...
            <div className="w-full md:w-1/2 text-white p-10 md:p-20 flex flex-col justify-center ml-12">
                ...
                <p className="text-gray-400 text-lg leading-relaxed mb-10">
                 gCurv platform has the unique ability to provide an overarching analysis of an entire portfolio that identifies common areas for improvement and strengths
                </p>
                <p className="text-gray-400 text-lg leading-relaxed mb-10">
        ...
        <section className="flex flex-col md:flex-row w-full h-screen -mt-44" >
            ...
            <div className="w-full md:w-1/2 text-white p-10 md:p-20 flex flex-col justify-center ml-12">
                ...
                <p className="text-gray-400 text-lg leading-relaxed mb-10">
                 gCurv notifies our customer when there are incoming packaging regulations that may impact their current-state packaging
                </p> 
                <p className="text-gray-400 text-lg leading-relaxed mb-10">
        ...
        <section className="flex flex-col md:flex-row w-full h-screen -mt-44" >
            ...
            <div className="w-full md:w-1/2 text-white p-10 md:p-20 flex flex-col justify-center ml-12">
                ...
                <p className="text-gray-400 text-lg leading-relaxed mb-10">
                The gCurv team then connects our customers with those packaging solution providers to ensure a true beginning to end solution.
                </p>
            </div>
            {/* Right: Image/Video Placeholder */}
            <img
